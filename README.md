...
- **🏆 Glicko-2 레이팅 시스템**: 4~6인 단체 레이스 결과를 승패 대결로 변환하여 객관적인 선수 기량 및 백테스트 모델 제공
...
flowchart LR
    ...
    C --> E["Glicko-2 레이팅<br/>(rating.engine)"]
...
| **[📐 도메인 규칙 & 분석 알고리즘](docs/domain_rules.md)**          | 라운드(Final A/B) 판정, ID 통합 룰, 코호트 생존분석, Stop Rule 수식     |
...
- **Rating Engine**: Glicko-2, TrueSkill, SciPy / NumPy
