...
| `python collect_full_history.py collect`           | 네트워크 원천(INF201→INF202→INF301→INF310), 기존 캐시/진행상태(`data/raw/**`, `data/collect_progress.json`)                                                                    | `data/raw/inf201/{page}.html`, `data/raw/inf202/{classCd}_{toCd}.html`, `data/raw/inf301/{toCd}_{kindCd}_{detailClassCd}.html`, `data/raw/inf310/{toCd}_{kindCd}_{detailClassCd}_{baseClassCd}_{rhCd}_{pcntGbn}.html`, `data/raw/inf503/{idNo}.html`, `data/collect_progress.json`, `data/collect_failures.csv`, `data/records_full.csv`, `data/athlete_info_full.csv` | `analyze.py` 익명 통계 입력 우선, `build_data.py` 대회 집계 입력 우선 |
