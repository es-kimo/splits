...
| `python event_participants.py probe-inf202-actions ...` | 특정 대회 classCd/toCd 또는 event-index                                                                                                                                   | 선택: JSON 리포트(`--json-out`)                                                                                                                                                                                                                                                                                                                     | 미확인 엔드포인트 조사                                      |
| `python event_participants.py compare-classcd ...` | 동일 toCd + 비교 classCd(기본 1/2)                                                                                                                                          | 선택: JSON 리포트(`--json-out`)                                                                                                                                                                                                                                                                                                                     | classCd 차이 근거 수집                                      |
